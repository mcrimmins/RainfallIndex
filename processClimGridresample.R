...
writeRaster(prec,filename="/scratch/crimmins/climgrid/processed/AZNM_RainIndex/resamp_moSumPrecip_AZNM_climgrid_1948_2017.grd", overwrite=TRUE )
writeRaster(moAvg,filename="/scratch/crimmins/climgrid/processed/AZNM_RainIndex/resamp_moAvgPrecip_AZNM_climgrid_1948_2017.grd", overwrite=TRUE )
writeRaster(twoMoSumClimo,filename="/scratch/crimmins/climgrid/processed/AZNM_RainIndex/resamp_mo2AvgPrecip_AZNM_climgrid_1948_2017.grd", overwrite=TRUE )
writeRaster(percAvgPrecip,filename="/scratch/crimmins/climgrid/processed/AZNM_RainIndex/resamp_mo2percAvgPrecip_AZNM_climgrid_1948_2017.grd", overwrite=TRUE )
writeRaster(twoMoSumPrecip,filename="/scratch/crimmins/climgrid/processed/AZNM_RainIndex/resamp_mo2sumAvgPrecip_AZNM_climgrid_1948_2017.grd", overwrite=TRUE )
